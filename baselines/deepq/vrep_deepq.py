...
def main():
    ...
    def env_fn():
        env = UR5VrepEnvDis(server_port=19997, l2_thresh=0.09, num_per_dim=5, dof=3, discrete_stepsize=0.03, random_seed=1)
    ...
    model = learn(env, 'mlp', seed=1, lr=1e-4,
                  ...
                  load_path=None, hiddens=[512, 256, 256, 128])
    save_path = './cpt'
