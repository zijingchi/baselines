...
import numpy as np
import gym
from baselines.gail.vrep_ur_env import UR5VrepEnvConcat, PathPlanDset
...
def argsparser():
    ...
    parser.add_argument('--expert_path', type=str, default='dataset/ur5expert3')
    ...
    parser.add_argument('--d_step', help='number of steps to train discriminator in each epoch', type=int, default=3)
...
def main(args):
    ...
    env = UR5VrepEnvConcat(l2_thresh=0.08)
    ...
    if args.task == 'train':
        dataset = PathPlanDset(expert_path=args.expert_path, traj_limitation=args.traj_limitation, thresh=0.08)
...
def train(env, seed, policy_fn, reward_giver, dataset, algo,
    ...
    if algo == 'trpo':
        ...
        trpo_mpi.learn(env, policy_fn, reward_giver, dataset, rank,
                       ...
                       timesteps_per_batch=1600,
                       max_kl=0.04, cg_iters=40, cg_damping=0.1,
                       gamma=0.995, lam=0.97, d_stepsize=1e-4,
